...
/**
 * Class EntitiesOperation
 * Project platform.
 *
 * @author  Anton Prokhorov <vziks@live.ru>
 */
class EntitiesOperation implements OperationInterface
{
    use TraitOperation;
    ...
    {
        return OperationInterface::SERIALIZATION_CONTEXT_ENTITIES;
    }
    ...
    {
        return '/text/analytics/v2.1/entities';
    }
