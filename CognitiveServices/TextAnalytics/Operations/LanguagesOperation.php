...
/**
 * Class LanguagesOperation
 * Project platform.
 *
 * @author  Anton Prokhorov <vziks@live.ru>
 */
class LanguagesOperation implements OperationInterface
{
    use TraitOperation;
    ...
    {
        return OperationInterface::SERIALIZATION_CONTEXT_LANGUAGES;
    }
    ...
    {
        return '/text/analytics/v2.1/languages';
    }
